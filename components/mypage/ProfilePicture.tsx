...
const ProfilePicture = () => {
  ...
  const defaultAvatarUrl =
    "https://vmyzbnqvfwwmhoazveei.supabase.co/storage/v1/object/public/avatar/default/avatar.svg";
  ...
  async function handleFileChange(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      await refreshProfile(); // Genindlæs siden for at vise det nye billede
    ...
    <div className="flex flex-col items-center">
      ...
      <label className="cursor-pointer">
        ...
        <img
          ...
          alt="Profile billede"
          className="w-40 h-40 rounded-full object-cover border bg-white border-gray-300"
        />
      ...
      {isUploading && <p className="text-sm text-gray-500 mt-2">Uploader...</p>}
    </div>
  );
};
